...
import { HeaderItemProps, StyledBuyId, StyledStockName, StyledTotalPurchase } from './HeaderItem';
...
export const HEADER_LIST: HeaderItemProps[] = [
  ...
  { id: '2', label: 'Stock Name', fixedWidth: 120, Component: StyledStockName, notTableHead: false },
  { id: '3', label: '#', fixedWidth: 50, Component: StyledBuyId, notTableHead: false },
...
export const SUB_GROUP_HEADER_LIST: HeaderItemProps[] = HEADER_LIST.filter(h => !NOT_SUBGROUP_COL.includes(h.id));
